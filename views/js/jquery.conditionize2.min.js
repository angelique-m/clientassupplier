(function ($) {
  $.fn.conditionize = function (options) {
    ...
    var settings = $.extend(
      { updateOn: "change", onload: true, ifTrue: "show", ifFalse: "hide" },
      options
    );
    ...
    function prepareActions(e) {
      ...
      if (
        ...
        e.every(function (e) {
          return (
            (typeof e === "string" && $.fn.conditionize.actions.hasOwnProperty(e.split(":")[0])) ||
            typeof e === "function"
          );
        })
      ) {
      ...
      throw new TypeError(
        "Incorrect action type for ifTrue or ifFalse." +
    ...
    return this.each(function () {
      ...
      cond = cond.replace($.fn.conditionize.re, function (e, i) {
        var n = i.substring(0, 1) === "#" ? i : "[name='" + i + "']";
        if ($(n).length) {
          if (allFields.indexOf(n) === -1) {
            allFields.push(n);
          }
          return '$.fn.conditionize.getValue("' + n + '")';
        } else {
          return i;
        }
      });
