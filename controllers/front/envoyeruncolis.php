<?php
class ClientassupplierEnvoyeruncolisModuleFrontController extends ModuleFrontController
{
    /** @var bool */
    public $auth = true;
    /** @var bool */
    ...
    public function initContent()
    {
       ...
       $this->setTemplate('module:clientassupplier/views/templates/front/envoyeruncolis.tpl');
